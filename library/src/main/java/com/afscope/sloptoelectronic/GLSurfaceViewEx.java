...
public class GLSurfaceViewEx extends SurfaceView implements SurfaceHolder.Callback {
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public GLSurfaceViewEx(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * this interface, and then call {@link GLSurfaceViewEx#setRenderer} to
     ...
     * use the {@link GLSurfaceViewEx#queueEvent(Runnable)} convenience method.
     * <p>
     ...
     * {@link GLSurfaceViewEx#setEGLContextFactory(EGLContextFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GLSurfaceViewEx#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GLSurfaceViewEx#setEGLConfigChooser(EGLConfigChooser)}
     */
        ...
        private void guardedRun() throws InterruptedException {
            ...
            try {
                ...
                while (true) {
                    ...
                    boolean bNeedSwap = mRenderer.onDrawFrame(gl);
                    if(bNeedSwap){
                    	if (!mEglHelper.swap()) {
                            if (LOG_SURFACE) {
